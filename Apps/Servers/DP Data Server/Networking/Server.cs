...
namespace DatumPoint.Servers.DataServer
{
    /// <summary>
    ...
    {        
        ...
        static void Main(string[] args) 
        {
            ...
            {
                // Log error.
                Console.WriteLine("\"DP Data Server\" already started. Application not allow multiple instances at single moment.\nGUID: " + guid);
            ...
            for (int i = 0; i < threadsCount; i++)
            {
                ...
                // Set fields.
                serverBufer.pipeName = "DP_DS_QM_MAIN_INOUT";
